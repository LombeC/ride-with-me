...
public class CustomDrawerAdapter extends ArrayAdapter<DrawerItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dItem.isProfile()){
            ...
            drawerHolder.profilePicture.setImageDrawable(context.getResources().
                    getDrawable(dItem.getItemPictureResID())); // if it gives me problems, change context back to view
